                ...
                <form action="{{ route('users.update', $user) }}" method="POST" class="inline-block">
                    ...
                    <div class="grid mx-auto">
                        ...
                        <div class="grid mb-3 mx-auto rounded">
                            ...
                            <input type="text" name="cellphone" class="rounded text-center text-m"
                                value="{{ $user->cellphone }}" autofocus>
                            @error('cellphone')
                                {{ $message }}
                            @enderror
                        </div>
                    ...
                    <div class="grid">
                        <div class="grid mb-3 mx-auto rounded">
                            ...
                            <input type="text" name="address" class="rounded text-center text-m"
                                value="{{ $user->address }}">
                            @error('address')
                                {{ $message }}
                            @enderror
                        ...
                        <div class="grid mb-3 mx-auto rounded">
                            ...
                            <input type="text" name="city" class="rounded text-center text-m mb-1"
                                value="{{ $user->city }}">
                            @error('city')
                                {{ $message }}
                            @enderror
                        ...
                        <div class="grid mb-3 mx-auto rounded">
                            ...
                            <input type="text" name="state" class="rounded text-center text-m mb-1"
                                value="{{ $user->state }}">
                            @error('state')
                                {{ $message }}
                            @enderror
                        ...
                        <div class="grid mb-3 mx-auto rounded">
                            ...
                            <input type="text" name="country" class="rounded text-center text-m mb-1"
                                value="{{ $user->country }}">
                            @error('country')
                                {{ $message }}
                            @enderror
                        ...
                        <div class="inline-flex mx-auto items-center">
                            ...
                            <button type="submit"
                                class="text-center text-indigo-600 hover:text-indigo-900 ml-12 font-bold">Actualizar</button>
                        </div>
                    </div>
                </form>
