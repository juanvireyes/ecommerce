        ...
        <div class="container mx-auto px-6 py-4 items-center">
            ...
            <div class="flex justify-center text-center">
                <div class="flex-5 mx-2">
                    ...
                    <a href="{{ route('superadmin.index') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Gestión de usuarios</a>
                </div>
                <div class="flex-5 mx-2">
                    <a href="#">
        ...
        @else
            <div class="flex justify-center text-center">
                <div class="flex-5 mx-2">
                    ...
                    <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-3">Ver productos</a>
                </div>
            </div>
        @endif
        </div>
